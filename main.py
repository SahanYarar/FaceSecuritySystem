...
from common.constants import (
    CAMERA_SRC, FRAME_WIDTH, PROCESS_WIDTH,
    RECOG_DIST_THRESH, STREAK_THRESHOLD,
    EAR_THRESHOLD, EAR_CONSEC_FRAMES, REQUIRED_BLINKS,
    LIVENESS_TIMEOUT_FRAMES, HEAD_MOVEMENT_FRAMES,
    MIN_CENTROID_MOVEMENT, MAX_CENTROID_MOVEMENT,
    CENTROID_LANDMARK_INDICES, POSE_HISTORY_FRAMES,
    MIN_POSE_STD_DEV_SUM, POSE_LANDMARK_INDICES,
    LOOK_LEFT_RIGHT_ANGLE_THRESH, SERVO_PIN,
    SERVO_MIN_PULSE, SERVO_MAX_PULSE, SERVO_FRAME_WIDTH,
    CLOSED_ANGLE, OPEN_ANGLE, DOOR_OPEN_TIME,
    SHAPE_PREDICTOR_PATH, FACE_REC_MODEL_PATH,
    KNOWN_FACES_DB_PATH, COLOR_GREEN, COLOR_RED,
    COLOR_BLUE, COLOR_YELLOW, COLOR_WHITE,
    COLOR_BLACK, COLOR_GRAY, UI_BUTTON_HEIGHT,
    UI_BUTTON_WIDTH, UI_BUTTON_MARGIN, UI_INFO_POS,
    UI_STATUS_POS, UI_LIVENESS_POS, UI_INPUT_POS,
    UI_BUTTON_START_Y
)
